          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <div className="flex gap-3">
              <Link
                ...
                className="px-4 py-2 bg-gradient-to-r from-indigo-600 to-cyan-500 text-white rounded-xl text-sm font-medium hover:from-indigo-700 hover:to-cyan-600 transition-all flex items-center gap-1"
              >
                <svg
                  className="w-4 h-4"
                  fill="none"
